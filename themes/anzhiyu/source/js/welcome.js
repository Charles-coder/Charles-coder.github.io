...
$.ajax({
    ...
    data: {
        key: 'QB4BZ-NL6WL-PWEPF-EC3UP-H6QE2-LYF2L',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(108.84005,34.12952, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
