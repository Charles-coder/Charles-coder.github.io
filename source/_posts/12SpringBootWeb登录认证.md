---
title: Springboot笔记-12SpringBootWeb登录认证
date: 2023-09-3 10:39:41
tags: #后端开发 #SpringBoot
keywords: "记录SpringBoot的学习内容"
description: 记录了博主暑假学习第12天
...
![image-20230105085212629](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105085212629.png)
...
![image-20230105085404855](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105085404855.png)
...
![image-20230105175310401](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105175310401.png)
...
~~~java
//标识该类是一个处理rest请求的控制器，可以接受请求并返回
@RestController
public class LoginController {
//将需要的依赖（EmpService）自动注入到类中，无需手动创建对象
    @Autowired
    private EmpService empService;
//处理post请求的映射注解，指定了路径为login，post请求到的时候会调用login方法
    @PostMapping("/login")
//login方法的定义 ，requestbody表示返回
...
![image-20220907132229245](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20220907132229245.png) 

postman测试通过了，那接下来，我们就可以结合着前端工程进行联调测试。

先退出系统，进入到登录页面：

![image-20230105193104848](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105193104848.png)
...
![image-20230105192918098](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105192918098.png)
...
![image-20220907133329021](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20220907133329021.png)
...
![image-20230105180811717](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105180811717.png)
...
![image-20230105194710533](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105194710533.png)
...
![image-20230105203827355](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230105203827355.png)
...
![image-20230112101901417](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112101901417.png) 
...
![image-20230112101804878](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112101804878.png) 
...
![image-20230112105410076](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112105410076.png) 

我们可以看到，设置的cookie，通过**响应头Set-Cookie**响应给浏览器，并且浏览器会将Cookie，存储在浏览器端。

![image-20230112105538131](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112105538131.png) 



B. 访问c2接口 http://localhost:8080/c2，此时浏览器会自动的将Cookie携带到服务端，是通过**请求头Cookie**，携带的。

![image-20230112105658486](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112105658486.png) 
...
> 跨域介绍：
>
> ​	 <img src="https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112103840467.png" alt="image-20230112103840467" style="zoom:80%;" /> 
>
...
- 获取Session
  ...
  ![image-20230112105938545](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112105938545.png) 
...
- 响应Cookie (JSESSIONID)
  ...
  ![image-20230112110441075](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112110441075.png) 
...
- 查找Session
  ...
  ![image-20230112101943835](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112101943835.png) 
...
![image-20230112111004447](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112111004447.png) 
...
![image-20230112111137207](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112111137207.png) 
...
![image-20230112111328117](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112111328117.png) 
...
>
> ​	<img src="https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112112557480.png" alt="image-20230112112557480" style="zoom:67%;" /> 
>
> - 首先第一点，我们现在所开发的项目，一般都不会只部署在一台服务器上，因为一台服务器会存在一个很大的问题，就是单点故障。所谓单点故障，指的就是一旦这台服务器挂了，整个应用都没法访问了。
>
> ​    ![image-20230112112740131](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112112740131.png) 
>
...
>
>   ![image-20230112113558810](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112113558810.png) 
>
...
![image-20230112102022634](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112102022634.png) 
...
![image-20230106085442076](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106085442076.png)
...
![image-20230112114319773](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112114319773.png) 
...
![image-20230106190950305](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106190950305.png)
...
![image-20230106205045658](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106205045658.png)
...
![image-20230106212805480](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106212805480.png)

打开浏览器完成前后端联调操作：利用开发者工具，抓取一下网络请求

![image-20230106213419461](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106213419461.png)
...
![image-20230106213910049](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106213910049.png)



我们在发起一个查询部门数据的请求，此时我们可以看到在请求头中包含一个token(JWT令牌)，后续的每一次请求当中，都会将这个令牌携带到服务端。

![image-20230106214331443](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106214331443.png)
...
![image-20230112120955145](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112120955145.png) 
...
![image-20230112121205697](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112121205697.png) 
...
![image-20230106222559935](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106222559935.png)
...
![image-20230106224322625](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106224322625.png)
...
![image-20230106225658525](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106225658525.png)

![image-20230106230332510](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106230332510.png)



测试2：访问登录请求/login，发现过滤器拦截请求

![image-20230106230520229](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106230520229.png)
...
![image-20230106231144348](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106231144348.png)



测试2：访问登录请求/login，发现过滤器没有拦截请求

![image-20230106231220802](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230106231220802.png)
...
![image-20230107084730393](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107084730393.png)
...
![image-20230107085552176](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107085552176.png)
...
![image-20230107090425999](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107090425999.png)
...
![image-20230107093757050](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107093757050.png)
...
![image-20230107095010089](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107095010089.png)
...
![image-20230112122130564](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112122130564.png) 
...
- 测试2：先进行登录操作，再访问部门管理页面
  ...
  ![image-20230107102922550](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107102922550.png)
...
![image-20230107105224741](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107105224741.png)

![image-20230107105415120](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107105415120.png)
...
![image-20230107105815511](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107105815511.png)
...
![image-20230107111525558](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107111525558.png)

控制台没有输出拦截器中的日志信息，说明`/*`没有匹配到拦截路径`/emp/1` 。

![image-20230107111812963](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107111812963.png)
...
![image-20230107112136151](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107112136151.png)
...
![image-20230107113653871](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107113653871.png)

![image-20230107114008004](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107114008004.png)
...
<img src="https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112125651073.png" alt="image-20230112125651073" style="zoom: 80%;" />   

点击确定之后，窗口关闭了，页面没有任何反应，就业部也没有添加上。 而此时，大家会发现，网络请求报错了。

<img src="https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112125737863.png" alt="image-20230112125737863" style="zoom:80%;" /> 

状态码为500，表示服务器端异常，我们打开idea，来看一下，服务器端出了什么问题。

![image-20230112125826602](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112125826602.png) 
...
![image-20230112130253486](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112130253486.png) 
...
![image-20230107121909087](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107121909087.png)
...
![image-20230107122904214](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230107122904214.png)
...
![image-20230112131232032](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112131232032.png) 

![image-20230112131135272](https://pic-1318156172.cos.ap-beijing.myqcloud.com/blog/image-20230112131135272.png) 
